...
//ADMIN ROUTES
Route::get('/admin/users', [App\Http\Controllers\AdminController::class, 'index'])->name('adminIndex');
Route::get('/admin/users/{user_id}', [App\Http\Controllers\AdminController::class, 'show'])->name('adminShowUser');
Route::patch('/admin/users/{user_id}', [App\Http\Controllers\AdminController::class, 'update'])->name('adminUpdate');
Route::delete('/admin/users/{user_id}', [App\Http\Controllers\AdminController::class, 'delete'])->name('adminDelete');
